(function () {
  ...
  // UK LTE Band 8 (L900): 3GPP E-UTRA Band 8
  const BAND8 = {
    band: 8,
    type: "FDD",
    dl: [925, 960],
  ...
  const CHARTS = [
    {
      title: "Band 8 (L900) Downlink (DL)",
      laneLabel: "DL",
      freqRange: BAND8.dl,
      earfcnRange: BAND8.dlEarfcn,
      cls: "bar-dl"
    },
    {
      title: "Band 8 (L900) Uplink (UL)",
      laneLabel: "UL",
      freqRange: BAND8.ul,
      earfcnRange: BAND8.ulEarfcn,
      cls: "bar-ul"
    }
  ];
  ...
  // User-specified carriers for Band 8 page
  drawCarrierSymbol({
    lane: "DL",
    label: "Vodafone 10 MHz (EARFCN 3501)",
    centerEarfcn: 3501,
    bandwidthMhz: 10,
    lineColor: "#ff4d4d",
    markerFill: "#ff4d4d",
  ...
  drawCarrierSymbol({
    lane: "UL",
    label: "Vodafone 10 MHz (EARFCN 21501)",
    centerEarfcn: 21501,
    bandwidthMhz: 10,
    lineColor: "#ff4d4d",
    markerFill: "#ff4d4d",
  ...
  drawCarrierSymbol({
    lane: "UL",
    label: "VMO2 10 MHz (EARFCN 21725)",
    centerEarfcn: 21725,
    bandwidthMhz: 10,
    lineColor: "#3b82f6",
    markerFill: "#3b82f6",
