(function () {
  ...
  // UK LTE Band 20 (L800): 3GPP E-UTRA Band 20
  const BAND20 = {
    band: 20,
    type: "FDD",
    dl: [791, 821],
  ...
  const CHARTS = [
    {
      title: "Band 20 (L800) Downlink (DL)",
      laneLabel: "DL",
      freqRange: BAND20.dl,
      earfcnRange: BAND20.dlEarfcn,
      cls: "bar-dl"
    },
    {
      title: "Band 20 (L800) Uplink (UL)",
      laneLabel: "UL",
      freqRange: BAND20.ul,
      earfcnRange: BAND20.ulEarfcn,
      cls: "bar-ul"
    }
  ];
  ...
  // DL carriers (user-specified UK Band 20 layout)
  drawCarrierSymbol({
    lane: "DL",
    label: "THREE 5 MHz (EARFCN 6175)",
    centerEarfcn: 6175,
    bandwidthMhz: 5,
    lineColor: "#facc15",
    markerFill: "#facc15",
  ...
  drawCarrierSymbol({
    lane: "DL",
    label: "Vodafone 10 MHz (EARFCN 6300)",
    centerEarfcn: 6300,
    bandwidthMhz: 10,
    lineColor: "#ff4d4d",
    markerFill: "#ff4d4d",
  ...
  drawCarrierSymbol({
    lane: "UL",
    label: "THREE 5 MHz (EARFCN 24175)",
    centerEarfcn: 24175,
    bandwidthMhz: 5,
    lineColor: "#facc15",
    markerFill: "#facc15",
  ...
  drawCarrierSymbol({
    lane: "UL",
    label: "Vodafone 10 MHz (EARFCN 24300)",
    centerEarfcn: 24300,
    bandwidthMhz: 10,
    lineColor: "#ff4d4d",
    markerFill: "#ff4d4d",
  ...
  drawCarrierSymbol({
    lane: "UL",
    label: "VMO2 10 MHz (EARFCN 24400)",
    centerEarfcn: 24400,
    bandwidthMhz: 10,
    lineColor: "#3b82f6",
    markerFill: "#3b82f6",
