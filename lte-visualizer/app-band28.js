(function () {
  ...
  // UK LTE Band 28 (L700): 3GPP E-UTRA Band 28
  const BAND28 = {
    band: 28,
    type: "FDD",
    dl: [758, 803],
  ...
  const CHARTS = [
    {
      title: "Band 28 (L700) Downlink (DL)",
      laneLabel: "DL",
      freqRange: BAND28.dl,
      earfcnRange: BAND28.dlEarfcn,
      cls: "bar-dl"
    },
    {
      title: "Band 28 (L700) Uplink (UL)",
      laneLabel: "UL",
      freqRange: BAND28.ul,
      earfcnRange: BAND28.ulEarfcn,
      cls: "bar-ul"
    }
  ];
  ...
  // User-specified carriers for Band 28 page
  drawCarrierSymbol({
    lane: "DL",
    label: "VMO2 10 MHz (EARFCN 9260)",
    centerEarfcn: 9260,
    bandwidthMhz: 10,
    lineColor: "#3b82f6",
    markerFill: "#3b82f6",
  ...
  drawCarrierSymbol({
    lane: "DL",
    label: "THREE 10 MHz (EARFCN 9360)",
    centerEarfcn: 9360,
    bandwidthMhz: 10,
    lineColor: "#facc15",
    markerFill: "#facc15",
  ...
  drawCarrierSymbol({
    lane: "UL",
    label: "VMO2 10 MHz (EARFCN 27260)",
    centerEarfcn: 27260,
    bandwidthMhz: 10,
    lineColor: "#3b82f6",
    markerFill: "#3b82f6",
  ...
  drawCarrierSymbol({
    lane: "UL",
    label: "THREE 10 MHz (EARFCN 27360)",
    centerEarfcn: 27360,
    bandwidthMhz: 10,
    lineColor: "#facc15",
    markerFill: "#facc15",
