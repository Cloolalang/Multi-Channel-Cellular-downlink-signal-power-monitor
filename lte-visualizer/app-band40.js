(function () {
  ...
  // LTE Band 40 (2300 MHz) TDD
  const BAND40 = {
    band: 40,
    type: "TDD",
    dl: [2300, 2400],
    ul: [2300, 2400],
    dlEarfcn: [38650, 39649],
    ulEarfcn: [38650, 39649]
  };
  const PAGE_BAND = 40;
  ...
  const CHARTS = [
    {
      title: "Band 40 (L2300) Downlink (DL)",
      laneLabel: "DL",
      freqRange: BAND40.dl,
      earfcnRange: BAND40.dlEarfcn,
      cls: "bar-dl"
    },
    {
      title: "Band 40 (L2300) Uplink (UL)",
      laneLabel: "UL",
      freqRange: BAND40.ul,
      earfcnRange: BAND40.ulEarfcn,
      cls: "bar-ul"
    }
  ];
  ...
  // User-specified VMO2 carriers (same EARFCN centers on DL/UL for TDD visualization)
  const vm02Color = {
    lineColor: "#3b82f6",
    markerFill: "#3b82f6",
    markerStroke: "#a9c8ff"
  ...
  for (const c of carriers) {
    drawCarrierSymbol({
      lane: "DL",
      label: `VMO2 ${c.bw} MHz (EARFCN ${c.earfcn})`,
      centerEarfcn: c.earfcn,
      bandwidthMhz: c.bw,
      ...vm02Color
    });
    drawCarrierSymbol({
